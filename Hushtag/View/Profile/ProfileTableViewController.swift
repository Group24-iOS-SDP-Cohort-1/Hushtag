...
class ProfileTableViewController: UITableViewController {
    ...
    func setupUI() {
            ...
            // IMPORTANT: The cornerRadius must be exactly half the width/height constraint you set in storyboard (120 / 2 = 60)
        profileImageView.layer.cornerRadius = 75
            profileImageView.clipsToBounds = true
            
            // Optional: Add a light border if you want
            ...
            // Add the "X" close button on the left
